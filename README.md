# Literature
Java:
* [0.1] "Философия Java. Брюс Эккель, 4-ое полное издание, 2015-ый год, 1170 страниц"
* [0.2.1] "Java. Полное руководство" (Герберт Шилдт), 12-ое издание, 2022-ой год, 1345 страниц.
* [0.2.2] "Schildt H., Coward D. Java. The Complete Reference 13ed 2024.pdf", 2147 страниц.
* [0.3] "Java. Библиотека профессионала. Том 1. Основы. Одиннадцатое издание. Кей Хорстманн", 2019-ый год, 866 страниц.
* [0.4] "Самое Полное Руководство По Разработке Java. В примерах от сообщества Stack Overflow", 2024-ый год, 672 страницы.
...
* [26] https://qojav.github.io/java-developer-roadmap/languages/ru/phase1/
...
* [14] "Jeanne_Boyarsky,_Scott_Selikoff_OCP_Oracle_Certified_Professional.pdf":: глава 13 "Concurrency", страницы 787 - 851
...
* [8.8] Data → Spring → Spring Core → "Spring-Core-MindMap2"
...
* [7.1] Data → PostgreSQL → Курс-Трегулов-SQL → "Часть1-SQL-Трегулов-Кратко"
* [7.2] Data → PostgreSQL → Курс-Трегулов-SQL → "SQL-MindMap"
...
* [7] Colab Google, Jupyter Notebook, GigaIDE Cloud
